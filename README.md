...
1.  **Set up your Development Environment.**
    ...
    Make sure that you have Gatsby and Node.js installed. 
    Instructions can be found here: https://www.gatsbyjs.org/tutorial/part-zero/
    Following this will set up Homebrew to allow you to install Node.js and npm.
    Then using npm you can install Gatsby CLI.

2.  **Clone the Project.**

    Once you have your development environment set up, you can clone this project. 
